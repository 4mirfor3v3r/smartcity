...
class VurnPointFragment : DevFragment<FragmentVurnPointBinding>(R.layout.fragment_vurn_point),
    ...
    private val listMarker: List<SearchHistoryDangerModel> = listOf(
        SearchHistoryDangerModel(0,"CCTV Cipaganti","Jl. Raden AA. Wiranata Kusumah No.29-31, Pasir Kaliki, Kec. Cicendo, Kota Bandung, Jawa Barat 40171",-6.900243, 107.602264),
