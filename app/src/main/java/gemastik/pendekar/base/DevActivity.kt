...
abstract class DevActivity<T : ViewDataBinding>(@LayoutRes private val layoutResId: Int) :
    ...
    open val vm: DevViewModel = DevViewModel(CompositeDisposable())
    ...
    protected fun refreshActivity(){
        ...
        mCurrentActivity.overridePendingTransition(gemastik.pendekar.R.anim.anim_flip_in, gemastik.pendekar.R.anim.anim_flip_out)
