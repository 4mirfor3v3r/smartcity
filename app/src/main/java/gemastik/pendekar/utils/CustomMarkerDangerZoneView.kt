...
class CustomMarkerDangerZoneView(root: ViewGroup,
    ...
    init {
        ...
        mTitle.text = text
//        if (isSelected) {
        mImage.setImageResource(R.drawable.ic_pin_danger_zone)
//        } else {
...
//        }
    ...
    companion object {
        fun getMarkerIcon(root: ViewGroup, text: String?): BitmapDescriptor {
            val markerView = CustomMarkerDangerZoneView(root, text)
